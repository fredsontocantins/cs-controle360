...
class ReportGenerator:
    ...
    def _build_management_report(
        ...
        # Bolt Optimization: pre-fetch full operational records once and re-use in memory
        # to prevent redundant DB queries during cycle summary calculations.
        ...
        all_releases_history = all_releases
