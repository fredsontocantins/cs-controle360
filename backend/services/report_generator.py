...
class ReportGenerator:
    ...
    def _build_management_report(
        ...
        # Bolt Performance Optimization: Pre-fetch operational lists once to reuse across cycle summary calculations.
        # Impact: Eliminates up to 8 redundant DB queries per management report generation.
