...
class ReportGenerator:
    ...
    def _build_management_report(
        ...
        # Optimization: Pre-fetch full operational lists once and reuse across cycle calculations
        ...
        homologacoes = all_homologacoes_full
        customizacoes = all_customizacoes_full
        if cycle_start:
            homologacoes = [
                row
