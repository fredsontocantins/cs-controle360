...
class ReportService:
    ...
    def get_html_report(self, **kwargs):
        ...
        # Pop release_name to avoid duplicate keyword argument error in generator
        passed_release_name = kwargs.pop("release_name", None)
        release_name = self._resolve_release_name(release_id, passed_release_name)
