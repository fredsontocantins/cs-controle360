...
def ensure_tables() -> None:
    ...
    conn.execute(f"CREATE TABLE IF NOT EXISTS {TABLE_AUTH_AUDIT} (id INTEGER PRIMARY KEY AUTOINCREMENT, actor_user_id INTEGER, actor_username TEXT, target_user_id INTEGER, target_username TEXT, event_type TEXT, action TEXT, message TEXT, provider TEXT, ip_address TEXT, user_agent TEXT, details_json TEXT, status TEXT, created_at TEXT NOT NULL)")
