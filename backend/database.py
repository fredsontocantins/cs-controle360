...
def ensure_tables() -> None:
    ...
    conn.execute(f"CREATE TABLE IF NOT EXISTS {TABLE_USER} (id INTEGER PRIMARY KEY AUTOINCREMENT, username TEXT UNIQUE NOT NULL, email TEXT, password_hash TEXT, role TEXT DEFAULT 'user', provider TEXT DEFAULT 'local', google_sub TEXT, full_name TEXT, approval_status TEXT DEFAULT 'pending', is_active INTEGER DEFAULT 1, created_at TEXT, updated_at TEXT, last_login_at TEXT)")
