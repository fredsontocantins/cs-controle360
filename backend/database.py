...
def ensure_tables() -> None:
    ...
    conn.execute(f"CREATE TABLE IF NOT EXISTS {TABLE_REPORT_CYCLE} (id INTEGER PRIMARY KEY AUTOINCREMENT, cycle_number INTEGER NOT NULL, scope_type TEXT NOT NULL, scope_id INTEGER, scope_label TEXT, period_label TEXT, status TEXT DEFAULT 'aberto', notes TEXT, created_at TEXT NOT NULL, updated_at TEXT, closed_at TEXT)")

    # Ensure columns exist for existing databases (SQLite migrations)
