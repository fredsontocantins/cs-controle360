...
def ensure_tables() -> None:
    ...
    conn.execute(f"CREATE TABLE IF NOT EXISTS {TABLE_AUTH_AUDIT} (id INTEGER PRIMARY KEY AUTOINCREMENT, actor_user_id INTEGER, actor_username TEXT, target_user_id INTEGER, target_username TEXT, event_type TEXT, status TEXT, provider TEXT, message TEXT, details_json TEXT, action TEXT, created_at TEXT NOT NULL)")
    ...
    _ensure_column(conn, TABLE_AUTH_AUDIT, "action", "TEXT")
