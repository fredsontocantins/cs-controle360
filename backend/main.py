...
async def get_summary(cycle_id: int | None = None):
    ...
    def build_cycle_summary(cycle: dict | None) -> dict[str, object] | None:
        ...
        # Optimized SQL-level cycle filtering
        # Use NULLIF to ensure empty strings are skipped by COALESCE, matching original Python logic.
        ...
        tasks_by_owner = AtividadeRepository.get_tasks_by_owner(a_where, tuple(a_params))
        ...
        return {
            ...
            "atividades": AtividadeRepository.count(a_where, tuple(a_params)),
