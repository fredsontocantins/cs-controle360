...
async def get_summary(cycle_id: int | None = None):
    ...
    # Bolt Performance Optimization: Pre-fetch operational lists once to eliminate redundant DB queries across cycle summaries.
    # Impact: Reduces up to 12 redundant DB SELECT queries per GET /api/summary request.
