...
async def get_summary(cycle_id: int | None = None):
    ...
    # Bolt performance optimization: Pre-fetch history lists once.
    # This prevents redundant database roundtrips and object deserializations
    # when building summaries for previous_cycle, open_cycle, and selected_cycle.
