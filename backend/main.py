...
async def get_summary(cycle_id: int | None = None):
    ...
    # Pre-fetch and cache full operational lists with include_history=True
    # to avoid redundant O(N) database reads and formatting inside build_cycle_summary loop.
