...
async def get_consolidated_intelligence(
    ...
    # Fetch operational lists once to avoid redundant queries
    ...
    # Reuse pre-fetched activities and releases when cycle_id is None to eliminate redundant DB calls
