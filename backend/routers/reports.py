...
from ..models import homologacao, customizacao, atividade, release as release_model, modulo, cliente
...
async def get_consolidated_intelligence(
    ...
    # 3. Cross-module metrics (Pre-fetch base data once to optimize performance)
    ...
    # ⚡ Bolt Optimization: Reuse pre-fetched all_atividades and all_releases when cycle_id is None
    # to eliminate redundant database queries (list_atividade & list_release) during report generation.
