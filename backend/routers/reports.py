...
from ..models import homologacao, customizacao, atividade, modulo, cliente, release as release_model
...
async def get_consolidated_intelligence(
    ...
    # 3. Cross-module metrics - pre-fetch first for reuse
    ...
    # PERFORMANCE OPTIMIZATION: Reuse standard lists if cycle_id is None, preventing redundant database calls
