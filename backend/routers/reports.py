...
async def get_consolidated_intelligence(
    ...
    # Fetch cross-module base lists first (reused to avoid redundant DB calls when cycle_id is None)
    ...
    # Optimization: reuse pre-fetched records when cycle_id is None to avoid duplicate database queries
