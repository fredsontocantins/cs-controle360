...
async def get_consolidated_intelligence(
    ...
    pdf_audit = pdf_service.build_cycle_audit(docs=pdf_docs)

    # 2. Cross-module metrics pre-fetching
    ...
    # 3. Playbook dashboard (reuse pre-fetched lists when cycle_id is None)
