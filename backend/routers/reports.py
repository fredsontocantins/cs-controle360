...
async def get_consolidated_intelligence(
    ...
    # 2. Cross-module metrics & pre-fetched operational lists
    # Bolt ⚡ Performance optimization: Pre-fetch operational records once and reuse them
    # when cycle_id is None, preventing redundant list_atividade() and list_release() queries.
