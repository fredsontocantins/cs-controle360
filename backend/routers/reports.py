...
async def get_consolidated_intelligence(
    ...
    # Fetch cross-module collections once to reuse in playbook calculations when cycle_id is None
    ...
    if cycle_id is not None:
        ...
        # Reuse pre-fetched lists to avoid duplicate DB queries and deserialization
