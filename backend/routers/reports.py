...
async def get_consolidated_intelligence(
    ...
    # 2. Cross-module metrics and operational datasets
    ...
    # Performance optimization: Reuse pre-fetched activities and releases when cycle_id is None
    # to avoid redundant DB list queries during report intelligence calculation
    if cycle_id is None:
