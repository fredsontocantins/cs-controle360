...
async def get_consolidated_intelligence(
    ...
    # 2. Cross-module metrics & Operational record pre-fetch
    ...
    # 3. Playbook dashboard (reuse pre-fetched activities/releases when cycle_id is None to avoid duplicate DB queries)
