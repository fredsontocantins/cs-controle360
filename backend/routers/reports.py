...
async def get_consolidated_intelligence(
    ...
    # Pre-fetch operational records once to avoid redundant DB queries
    ...
    # 2. Playbook dashboard (Bolt optimization: reuse pre-fetched records when cycle_id is None)
